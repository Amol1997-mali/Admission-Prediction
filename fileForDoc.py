...
df= pd.read_csv('C:/Ineuron# most important/machine learning/LinearRegression-master/LinearRegressionTillCloud/Admission_Prediction.csv') # reading the CSV file
